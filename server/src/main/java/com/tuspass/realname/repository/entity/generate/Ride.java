...
public class Ride implements Serializable {
    ...
    public Ride withOpenId(String openId) {
    ...
    public Ride withSelfPhone(String selfPhone) {
    ...
    public Ride withOthersPhone(String othersPhone) {
    ...
    public Ride withType(Integer type) {
        this.setType(type);
        return this;
    }
    ...
    public Ride withVehicleId(String vehicleId) {
    ...
    public Ride withLineId(String lineId) {
    ...
    public Ride withLineName(String lineName) {
    ...
    public Ride withCreateTime(Date createTime) {
    ...
    public Ride withAcceptTime(Date acceptTime) {
